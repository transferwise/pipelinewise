...
export const UPDATE_STREAMS = 'TapMysql/UPDATE_STREAMS';
export const UPDATE_STREAMS_SUCCESS = 'TapMysql/UPDATE_STREAMS_SUCCESS';
export const UPDATE_STREAMS_ERROR = 'TapMysql/UPDATE_STREAMS_ERROR';
