...
A number of taps developed by Singer.io or by other members of the community are open
...
List of the supported targets in PipelineWise can be found in the :ref:`targets_list` section.
