...
class TestReplicatePGToSF(TapPostgres):
    ...
    def test_replicate_pg_to_sf(self):
        ...
        #  INCREMENTAL
        last_id = self.e2e_env.run_query_tap_postgres("SELECT max(id) from public.city")[0][0]
        self.e2e_env.run_query_tap_postgres(
        ...
        assertions.assert_run_tap_success(self.tap_id, self.target_id, ["fastsync", "singer"], profiling=True)
