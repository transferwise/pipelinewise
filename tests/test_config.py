...
import pipelinewise.cli.config
...
class TestConfig(object):
        ...
        assert config.targets == {
            "test_snowflake_target": {
                ...
                "files": {
                    ...
                    "inheritable_config": "{}/test_snowflake_target/inheritable_config.json".format(PIPELINEWISE_TEST_HOME),
                ...
                "taps": [{
                    ...
                    "files": {
                        "config": "{}/test_snowflake_target/mysql_sample/config.json".format(PIPELINEWISE_TEST_HOME),
                        "inheritable_config": "{}/test_snowflake_target/mysql_sample/inheritable_config.json".format(PIPELINEWISE_TEST_HOME),
                        "properties": "{}/test_snowflake_target/mysql_sample/properties.json".format(PIPELINEWISE_TEST_HOME),
                        "selection": "{}/test_snowflake_target/mysql_sample/selection.json".format(PIPELINEWISE_TEST_HOME),
                        "state": "{}/test_snowflake_target/mysql_sample/state.json".format(PIPELINEWISE_TEST_HOME),
                        "transformation": "{}/test_snowflake_target/mysql_sample/transformation.json".format(PIPELINEWISE_TEST_HOME)
                    },
                    "schemas": [{
                        "source_schema": "my_db",
    ...
    def test_save_config(self):
        ...
        assert os.path.isfile("{}/test_snowflake_target/config.json".format(json_config_dir)) == True
        assert os.path.isfile("{}/test_snowflake_target/mysql_sample/config.json".format(json_config_dir)) == True
        assert os.path.isfile("{}/test_snowflake_target/mysql_sample/inheritable_config.json".format(json_config_dir)) == True
        assert os.path.isfile("{}/test_snowflake_target/mysql_sample/selection.json".format(json_config_dir)) == True
        assert os.path.isfile("{}/test_snowflake_target/mysql_sample/transformation.json".format(json_config_dir)) == True
