...
class TestResetState(TestCase):
    ...
    def test_reset_state_file_if_tap_is_pg(self):
        ...
        state_content = {"bookmarks": {"foo_table": {"lsn": 54321}, "bar_table": {"foo": "bar"}}}
        ...
        arguments = {"tap": "tap_pg", "target": "target_foo"}
        ...
        expected_state = {"bookmarks": {"foo_table": {"lsn": 1}, "bar_table": {"foo": "bar"}}}
    ...
    def test_reset_state_file_if_tap_is_mysql(self):
        ...
        state_content = {
            "bookmarks": {
                "foo_table": {"log_file": "mysql-bin.000001", "log_pos": old_pos, "version": 1},
                "bar_table": {"foo": "bar"},
            }
        }
        ...
        arguments = {"tap": "tap_mysql", "target": "target_foo"}
        self._run_cli(arguments)
        ...
        expected_state = {
            "bookmarks": {
                "foo_table": {"log_file": new_bin, "log_pos": new_pos, "version": 1},
                "bar_table": {"foo": "bar"},
            }
        }
        self.assertDictEqual(expected_state, actual_state)
    ...
    def test_exit_with_error_1_if_tap_is_mysql_but_no_record_in_switchover(self):
        ...
        state_content = {
            "bookmarks": {
                "foo_table": {"log_file": "mysql-bin.000001", "log_pos": 1, "version": 1},
                "bar_table": {"foo": "bar"},
            }
        }
    ...
    def test_exit_with_error_1_if_tap_is_not_allowed(self):
        ...
        arguments = {"tap": "tap_bar", "target": "target_foo"}
