...
class TestTransformHelper(unittest.TestCase):
    ...
    def test_get_trans_in_sql_case1(self):
        ...
        trans = TransformationHelper.get_trans_in_sql_flavor(table_name, transformations, SQLFlavor("snowflake"))
    ...
    def test_get_trans_in_sql_case2(self):
        ...
        trans = TransformationHelper.get_trans_in_sql_flavor(table_name, transformations, SQLFlavor("postgres"))
        self.assertFalse(trans)
    ...
    def test_get_trans_in_sql_case3(self):
        ...
        with self.assertRaises(ValueError):
            TransformationHelper.get_trans_in_sql_flavor(table_name, transformations, SQLFlavor("snowflake"))
    ...
    def test_get_trans_in_sql_case6(self):
        ...
        self.assertListEqual(
            ...
            [
                ...
                {
                    "trans": '"COL_6" = CONCAT(SUBSTRING("COL_6", 1, 5), SHA2(SUBSTRING("COL_6", 5 + 1), 256))',
                    "conditions": '("COL_1" = 30) AND ("COL_2" REGEXP \'[0-9]{3}\.[0-9]{3}\')',  # noqa: W605
                },
                {
                    "trans": '"COL_7" = CASE WHEN LENGTH("COL_7") > 2 * 3 THEN '
                    'CONCAT(SUBSTRING("COL_7", 1, 3), REPEAT(\'*\', LENGTH("COL_7")-(2 * 3)), '
                    'SUBSTRING("COL_7", LENGTH("COL_7")-3+1, 3)) '
                    "ELSE REPEAT('*', LENGTH(\"COL_7\")) END",
                    "conditions": '("COL_1" = 30) AND ("COL_2" REGEXP \'[0-9]{3}\.[0-9]{3}\') AND ("COL_4" IS NULL)',  # noqa: W605
                },
            ],
        )
        ...
        self.assertListEqual(
            ...
            [
                ...
                },
                {
                    ...
                    "'sha256'), 'hex'))",
                    "conditions": '("col_1" = 30) AND ("col_2" ~ \'[0-9]{3}\.[0-9]{3}\')',  # noqa: W605, E501
                },
                {
                    "trans": '"col_7" = CASE WHEN LENGTH("col_7") > 2 * 3 THEN '
                    'CONCAT(SUBSTRING("col_7", 1, 3), REPEAT(\'*\', LENGTH("col_7")-(2 * 3)), '
