...
def load_into_snowflake(target, args, columns_diff, primary_keys, s3_key_pattern, size_bytes, where_clause_sql):
    ...
    snowflake.copy_to_table(s3_key_pattern, target["schema"], args.table, size_bytes, is_temporary=True)
    # Obfuscate columns
...
def _get_target_columns_info(target_column):
    ...
    return {"column_names": list_of_target_column_names, "columns_dict": target_columns_dict}
