...
def table_to_csv(mysql_conn, catalog_entry, state, columns, stream_version, args):
    ...
    with connect_with_backoff(mysql_conn) as open_conn:
        with open_conn.cursor() as cur:
            select_sql = common.generate_select_sql(catalog_entry, columns, args.transform_config.get('transformations'))
