...
from tap_mysql.connection import connect_with_backoff, MySQLConnection, MYSQL_ENGINE, MARIADB_ENGINE
...
class TestTypeMapping(unittest.TestCase):
    ...
    def test_decimal(self):
        self.assertEqual(
            self.schema.properties["c_decimal"], Schema(["null", "number"], inclusion="available", multipleOf=1)
        )
        self.assertEqual(
            self.get_metadata_for_column("c_decimal"),
            {"selected-by-default": True, "sql-datatype": "decimal(10,0)", "datatype": "decimal"},
        )
    ...
    def test_decimal_unsigned(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "decimal(5,2) unsigned", "datatype": "decimal"},
        )

    def test_decimal_with_defined_scale_and_precision(self):
        self.assertEqual(
            self.schema.properties["c_decimal_2"], Schema(["null", "number"], inclusion="available", multipleOf=0.01)
        )
        self.assertEqual(
            self.get_metadata_for_column("c_decimal_2"),
            {"selected-by-default": True, "sql-datatype": "decimal(11,2)", "datatype": "decimal"},
        )
    ...
    def test_tinyint(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "tinyint(4)", "datatype": "tinyint"},
        )

    def test_tinyint_1(self):
        self.assertEqual(self.schema.properties["c_tinyint_1"], Schema(["null", "boolean"], inclusion="available"))
        self.assertEqual(
            self.get_metadata_for_column("c_tinyint_1"),
            {"selected-by-default": True, "sql-datatype": "tinyint(1)", "datatype": "tinyint"},
        )

    def test_tinyint_1_unsigned(self):
        self.assertEqual(
            self.schema.properties["c_tinyint_1_unsigned"], Schema(["null", "boolean"], inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_tinyint_1_unsigned"),
            {"selected-by-default": True, "sql-datatype": "tinyint(1) unsigned", "datatype": "tinyint"},
        )
    ...
    def test_smallint(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "smallint(6)", "datatype": "smallint"},
        )
    ...
    def test_mediumint(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "mediumint(9)", "datatype": "mediumint"},
        )
    ...
    def test_int(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "int(11)", "datatype": "int"},
        )
    ...
    def test_bigint(self):
        self.assertEqual(
            ...
            Schema(
                ["null", "integer"], inclusion="available", minimum=-9223372036854775808, maximum=9223372036854775807
            ),
        )
        self.assertEqual(
            self.get_metadata_for_column("c_bigint"),
            {"selected-by-default": True, "sql-datatype": "bigint(20)", "datatype": "bigint"},
        )

    def test_bigint_unsigned(self):
        self.assertEqual(
            self.schema.properties["c_bigint_unsigned"],
            Schema(["null", "integer"], inclusion="available", minimum=0, maximum=18446744073709551615),
        )

        self.assertEqual(
            self.get_metadata_for_column("c_bigint_unsigned"),
            {"selected-by-default": True, "sql-datatype": "bigint(20) unsigned", "datatype": "bigint"},
        )

    def test_float(self):
        self.assertEqual(self.schema.properties["c_float"], Schema(["null", "number"], inclusion="available"))
        self.assertEqual(
            self.get_metadata_for_column("c_float"),
            {"selected-by-default": True, "sql-datatype": "float", "datatype": "float"},
        )

    def test_double(self):
        self.assertEqual(self.schema.properties["c_double"], Schema(["null", "number"], inclusion="available"))
        self.assertEqual(
            self.get_metadata_for_column("c_double"),
            {"selected-by-default": True, "sql-datatype": "double", "datatype": "double"},
        )
    ...
    def test_bit(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "bit(4)", "datatype": "bit"},
        )
    ...
    def test_date(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": True, "sql-datatype": "date", "datatype": "date"},
        )

    def test_time(self):
        self.assertEqual(
            self.schema.properties["c_time"], Schema(["null", "string"], format="time", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_time"),
            {"selected-by-default": True, "sql-datatype": "time", "datatype": "time"},
        )
    ...
    def test_year(self):
        ...
        self.assertEqual(
            ...
            {"selected-by-default": False, "sql-datatype": "year(4)", "datatype": "year"},
        )
    ...
    def test_geometry(self):
        self.assertEqual(
            self.schema.properties["c_geometry"], Schema(["null", "object"], format="spatial", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_geometry"),
            {"selected-by-default": True, "sql-datatype": "geometry", "datatype": "geometry"},
        )

    def test_point(self):
        self.assertEqual(
            self.schema.properties["c_point"], Schema(["null", "object"], format="spatial", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_point"),
            {"selected-by-default": True, "sql-datatype": "point", "datatype": "point"},
        )

    def test_linestring(self):
        self.assertEqual(
            self.schema.properties["c_linestring"], Schema(["null", "object"], format="spatial", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_linestring"),
            {"selected-by-default": True, "sql-datatype": "linestring", "datatype": "linestring"},
        )

    def test_polygon(self):
        self.assertEqual(
            self.schema.properties["c_polygon"], Schema(["null", "object"], format="spatial", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_polygon"),
            {"selected-by-default": True, "sql-datatype": "polygon", "datatype": "polygon"},
        )

    def test_multipoint(self):
        self.assertEqual(
            self.schema.properties["c_multipoint"], Schema(["null", "object"], format="spatial", inclusion="available")
        )
        self.assertEqual(
            self.get_metadata_for_column("c_multipoint"),
            {"selected-by-default": True, "sql-datatype": "multipoint", "datatype": "multipoint"},
        )

    def test_multilinestring(self):
        self.assertEqual(
            self.schema.properties["c_multilinestring"],
            Schema(["null", "object"], format="spatial", inclusion="available"),
        )
        self.assertEqual(
            self.get_metadata_for_column("c_multilinestring"),
            {"selected-by-default": True, "sql-datatype": "multilinestring", "datatype": "multilinestring"},
        )

    def test_multipolygon(self):
        self.assertEqual(
            self.schema.properties["c_multipolygon"],
            Schema(["null", "object"], format="spatial", inclusion="available"),
        )
        self.assertEqual(
            self.get_metadata_for_column("c_multipolygon"),
            {"selected-by-default": True, "sql-datatype": "multipolygon", "datatype": "multipolygon"},
        )

    def test_geometrycollection(self):
        self.assertEqual(
            self.schema.properties["c_geometrycollection"],
            Schema(["null", "object"], format="spatial", inclusion="available"),
        )
        self.assertEqual(
            self.get_metadata_for_column("c_geometrycollection"),
            {"selected-by-default": True, "sql-datatype": "geometrycollection", "datatype": "geometrycollection"},
        )
...
class TestSelectsAppropriateColumns(unittest.TestCase):
    def runTest(self):
        ...
        self.assertEqual(got_cols, {"a", "c"}, "Keep automatic as well as selected, available columns.")
...
class TestIncrementalReplication(unittest.TestCase):
    ...
    def test_with_state(self):
        ...
        self.assertEqual(
            ["ActivateVersionMessage", "RecordMessage", "RecordMessage", "ActivateVersionMessage", "RecordMessage"],
            message_types,
        )
        self.assertTrue(isinstance(versions[0], int))
        self.assertEqual(versions[0], versions[1])
...
class TestBinlogReplication(unittest.TestCase):
    def setUp(self):
        ...
        for stream in self.catalog.streams:
            ...
            stream.metadata = [
                {
                    "breadcrumb": (),
                    "metadata": {"selected": True, "database-name": "tap_mysql_test", "table-key-properties": ["id"]},
                },
    ...
    def test_initial_full_table(self):
        ...
        self.assertEqual(
            singer.get_bookmark(state, "tap_mysql_test-binlog_1", "version"), activate_version_message_1.version
        )
    ...
    def test_binlog_stream_with_alteration(self):
        ...
        with connect_with_backoff(self.conn) as open_conn:
            with open_conn.cursor() as cursor:
                ...
                cursor.execute(
                    "INSERT INTO binlog_1 (id, updated, is_cancelled, data) "
                    "VALUES (2, '2017-06-20', true, 'blob content')"
                )
    ...
    def test_binlog_stream_switching_from_binlog_to_gtid_with_mysql_fails(self):
        ...
        self.assertEqual(
            "Couldn't find any gtid in state bookmarks to resume logical replication", str(context.exception)
        )
...
class TestSessionSqls(unittest.TestCase):
    ...
    def test_open_connections_with_invalid_session_sqls(self):
        ...
        # Test if session variables applied on connection
        self.assertEqual(self.executed_queries, ["SET SESSION max_statement_time=0", "SET SESSION wait_timeout=28800"])
