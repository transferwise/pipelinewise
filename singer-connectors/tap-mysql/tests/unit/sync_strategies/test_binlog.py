...
class TestBinlogSyncStrategy(TestCase):
    ...
    def test_add_automatic_properties(self):
        catalog = CatalogEntry(tap_stream_id="db-stream", schema=Schema(properties={"x": Schema(type="int")}))
    ...
    @patch(
        ...
        return_value=datetime.datetime(2020, 10, 13, 8, 29, 58, tzinfo=pytz.UTC),
    )
                ...
                "catalog_entry": CatalogEntry(
                    ...
                    metadata=[
                        ...
                        },
                        {
                            ...
                            "metadata": {"selected-by-default": True, "sql-datatype": "int(11)", "datatype": "int"},
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "metadata": {"selected-by-default": False, "sql-datatype": "blob", "datatype": "blob"},
                        },
                        {
                ...
                "catalog_entry": CatalogEntry(
                    ...
                    metadata=[
                        ...
                        },
                        {
                            ...
                            "metadata": {"selected-by-default": True, "sql-datatype": "double"},
                        },
                        {
                            "breadcrumb": ["properties", "c_time"],
                            "metadata": {"selected-by-default": True, "sql-datatype": "time"},
                        },
                    ],
                ),
        ...
        with patch("tap_mysql.sync_strategies.binlog.singer.write_message") as write_msg:
            ...
            with patch("tap_mysql.sync_strategies.binlog.BinLogStreamReader", autospec=True) as reader_mock:
                        ...
                        [
                            ...
                            get_binlogevent(
                                DeleteRowsEvent,
                                {
                                    ...
                                    "timestamp": datetime.datetime.timestamp(
                                        datetime.datetime(2021, 1, 1, 10, 20, 55, tzinfo=pytz.UTC)
                                    ),
                                    "columns": [
                                        Column("c_int", FIELD_TYPE.INT24),
                                        Column("c_varchar", FIELD_TYPE.VARCHAR),
                            ...
                            get_binlogevent(
                                DeleteRowsEvent,
                                {
                                    ...
                                    "table": "stream1",
                                    "timestamp": datetime.datetime.timestamp(
                                        datetime.datetime(2021, 1, 1, 20, 0, 0, tzinfo=pytz.UTC)
                                    ),
                                    "columns": [
                                        Column("c_int", FIELD_TYPE.INT24),
                                        Column("c_varchar", FIELD_TYPE.VARCHAR),
                            ...
                            CatalogEntry(
                                ...
                                schema=Schema(
                                    properties={
                                        ...
                                        "c_varchar": Schema(inclusion="available", type=["null", "string"]),
                                        "c_datetime": Schema(
                                            inclusion="available", type=["null", "string"], format="date-time"
                                        ),
                                    }
                                ),
                                metadata=[
                            ...
                            CatalogEntry(
                                ...
                                metadata=[
                                    ...
                                    },
                                    {
                                        ...
                                        "metadata": {"selected-by-default": True, "sql-datatype": "longtext"},
                                    },
                                ],
                            )
                        ]
                ...
                self.assertListEqual(
                    [type(msg) for msg in singer_messages],
                    [
                        RecordMessage,
                        RecordMessage,
                        RecordMessage,
                ...
                self.assertListEqual(
                    [msg for msg in singer_messages if isinstance(msg, RecordMessage)],
                    [
                        RecordMessage(
                            stream="my_db-stream2",
                ...
                self.assertListEqual(
                    [msg for msg in singer_messages if isinstance(msg, StateMessage)],
                    [
                        StateMessage(
                            value={
                                "bookmarks": {
                                    "my_db-stream1": {"log_file": "binlog0003", "log_pos": 999, "version": 1},
                                    "my_db-stream2": {"log_file": "binlog0003", "log_pos": 999, "version": 1},
                                }
                            }
                        ),
                    ],
    ...
    def test_verify_binlog_config_fail_if_not_FULL(self, connect_with_backoff):
        ...
        self.assertEqual(
            "Unable to replicate binlog stream because binlog_row_image is not set to 'FULL': Not-FULL.",
    ...
    def test_verify_binlog_config_fail_if_not_ROW(self, connect_with_backoff):
        ...
        self.assertEqual(
            "Unable to replicate binlog stream because binlog_format is not set to 'ROW': Not-ROW.",
            str(context.exception),
        )
    ...
    def test_verify_binlog_config_fail_if_binlog_row_image_not_supported(self, connect_with_backoff):
        ...
        cur_mock.__enter__.return_value.execute.side_effect = [None, InternalError(1193)]
