    ...
    with connect_with_backoff(mysql_conn) as open_conn:
        with open_conn.cursor() as cur:
            ...
            for k, cols in itertools.groupby(columns, lambda c: (c.table_schema, c.table_name)):
                ...
                def column_is_key_prop(column, table_schema):
                    return (
                        column.column_key == "PRI"
                        and table_schema.properties[column.column_name].inclusion != "unsupported"
                    )
...
def schema_for_column(column):  # noqa: PLR0912 - datatype mapping is intentionally branch-based
