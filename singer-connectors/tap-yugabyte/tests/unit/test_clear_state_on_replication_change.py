...
class TestClearState(unittest.TestCase):
    ...
    def test_incremental_happy(self):
        ...
        nascent_state = tap_yugabyte.clear_state_on_replication_change(
    ...
    def test_log_based_to_incremental(self):
        state = {
            'bookmarks': {
                tap_stream_id: {'version': 1, 'lsn': 34343434, "last_replication_method": "LOG_BASED"},
            },
        }
        nascent_state = tap_yugabyte.clear_state_on_replication_change(
            state, tap_stream_id, 'updated_at', 'INCREMENTAL'
    ...
    def test_full_table_happy(self):
        ...
        nascent_state = tap_yugabyte.clear_state_on_replication_change(state, tap_stream_id, None, 'FULL_TABLE')
        self.assertEqual(nascent_state, state)
    ...
    def test_full_table_interrupted(self):
        ...
        state = {
            'bookmarks': {
                tap_stream_id: {'version': 88, "last_replication_method": "FULL_TABLE", 'xmin': xmin},
            },
        }
        nascent_state = tap_yugabyte.clear_state_on_replication_change(state, tap_stream_id, None, 'FULL_TABLE')
        self.assertEqual(
            ...
            {
                'bookmarks': {
                    tap_stream_id: {"last_replication_method": "FULL_TABLE", 'version': 88, 'xmin': xmin},
                },
            },
        )
    ...
    def test_log_based_to_full_table(self):
        state = {
            'bookmarks': {
                tap_stream_id: {'version': 88, "last_replication_method": "LOG_BASED", 'lsn': 343434},
            },
        }
        nascent_state = tap_yugabyte.clear_state_on_replication_change(state, tap_stream_id, None, 'FULL_TABLE')
        self.assertEqual(
    ...
    def test_log_based_happy(self):
        ...
        nascent_state = tap_yugabyte.clear_state_on_replication_change(state, tap_stream_id, None, 'LOG_BASED')
        self.assertEqual(nascent_state, state)
