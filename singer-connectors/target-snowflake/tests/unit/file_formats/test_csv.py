...
class TestCsv(unittest.TestCase):
    ...
    def test_write_record_to_uncompressed_file(self):
        records = {"pk_1": "data1,data2,data3,data4", "pk_2": "data5,data6,data7,data8"}
        schema = {}
    ...
    def test_record_to_csv_line(self):
        ...
        self.assertEqual(
            csv.record_to_csv_line(record, schema), '"1","2030-01-22","10000-01-22 12:04:22","25:01:01","I\'m good",'
        )
    ...
    def test_create_copy_sql(self):
        self.assertEqual(
            csv.create_copy_sql(
                ...
                columns=[{"name": "COL_1"}, {"name": "COL_2"}, {"name": "COL_3", "trans": "parse_json"}],
            ),
