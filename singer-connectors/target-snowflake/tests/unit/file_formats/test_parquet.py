...
class TestParquet(unittest.TestCase):
    ...
    def test_records_to_dataframe(self):
        ...
        schema = {}
        assert_frame_equal(
            parquet.records_to_dataframe(records=records, schema=schema),
            DataFrame(
                {
                    "key1": [1, 2, 3],
        ...
        self.assertEqual(
            parquet.create_copy_sql(
                ...
                columns=[
                    ...
                    {"name": "COL_3", "json_element_name": "col_3", "trans": "parse_json"},
                ],
            ),
