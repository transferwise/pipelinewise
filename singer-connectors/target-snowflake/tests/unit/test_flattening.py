...
class TestFlattening(unittest.TestCase):
    ...
    def test_flatten_schema(self):
        ...
        self.assertEqual(
            flatten_schema(nested_schema_with_no_properties), nested_schema_with_no_properties["properties"]
        )
        ...
        self.assertEqual(
            flatten_schema(nested_schema_with_properties, max_level=0), nested_schema_with_properties["properties"]
        )
    ...
    def test_anyof_object_schema_uses_same_flattening_as_object_type_schema(self):
        ...
        object_type_schema = {
            ...
            "properties": {
                "c_pk": {"type": ["null", "integer"]},
                "c_obj": {"type": ["null", "object"], "properties": {"nested_prop": {"type": ["null", "string"]}}},
            },
        }
        ...
        anyof_object_schema = {
            ...
            "properties": {
                ...
                "c_obj": {
                    "anyOf": [
                        {"type": "object", "properties": {"nested_prop": {"type": ["null", "string"]}}},
                        {"type": ["null", "string"]},
                    ]
                },
            },
        ...
        self.assertEqual(
            flatten_schema(anyof_object_schema, max_level=1), flatten_schema(object_type_schema, max_level=1)
        )
