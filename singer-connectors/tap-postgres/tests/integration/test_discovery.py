...
class TestBoolsAndBits(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [{"name": "our_bool", "type": "boolean"}, {"name": "our_bit", "type": "bit"}],
    ...
    def test_catalog(self):
        ...
        self.assertEqual(
            {
                "properties": {"our_bool": {"type": ["null", "boolean"]}, "our_bit": {"type": ["null", "boolean"]}},
                "definitions": BASE_RECURSIVE_SCHEMAS,
                "type": "object",
            },
            stream_dict.get("schema"),
...
class TestJsonTables(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [{"name": "our_secrets", "type": "json"}, {"name": "our_secrets_b", "type": "jsonb"}],
...
class TestUUIDTables(unittest.TestCase):
    ...
    def setUp(self):
        table_spec = {
            "columns": [{"name": "our_pk", "type": "uuid", "primary_key": True}, {"name": "our_uuid", "type": "uuid"}],
    ...
    def test_catalog(self):
        ...
        self.assertEqual(
            {
                "properties": {"our_uuid": {"type": ["null", "string"]}, "our_pk": {"type": ["string"]}},
                "type": "object",
                "definitions": BASE_RECURSIVE_SCHEMAS,
            },
            stream_dict.get("schema"),
    ...
    def test_catalog(self):
        ...
        with get_test_connection() as conn:
            with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cur:
                cur.execute(
                    """INSERT INTO "CHICKEN TIMES" (our_pk, our_hstore)
    ...
    def test_catalog(self):
        ...
        with get_test_connection() as conn:
            with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cur:
                ...
                self.assertEqual(
                    {
                        "properties": {"our_money": {"type": ["null", "string"]}, "our_money_pk": {"type": ["string"]}},
                        "type": "object",
                        "definitions": BASE_RECURSIVE_SCHEMAS,
                    },
                    stream_dict.get("schema"),
